...
$(function () {
    ...
    function create_post() {
        console.log("Entered create_post() temp function.");
        $.ajax({
            url: "", // the endpoint
            ...
            success: function () {
                generateValues();
                console.log("POSTing was temp successful."); // another sanity check
            },
...
$(function () {
    ...
    function create_post_ws() {
        ...
        $.ajax({
            ...
            success: function () {
                generateValues();
                console.log("POSTing for WSnwas successful."); // another sanity check
            },
...
$(function () {
    ...
    function create_post_fl() {
        ...
        $.ajax({
            ...
            success: function () {
                generateValues();
                console.log("POSTing for Fuel Level sensor successful."); // another sanity check
            },
